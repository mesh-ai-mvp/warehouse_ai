declare module 'react-plotly.js' {
  ...
  export interface PlotParams {
    ...
    onInitialized?: (figure: { data: PlotData[]; layout: Partial<Layout> }, graphDiv: HTMLElement) => void;
    onUpdate?: (figure: { data: PlotData[]; layout: Partial<Layout> }, graphDiv: HTMLElement) => void;
