  ...
  switch (status) {
    case 'completed':
      return (
        <Badge
          variant="default"
          className="text-green-700 bg-green-100 dark:text-green-400 dark:bg-green-900/30"
        >
          Completed
        </Badge>
      )
    ...
    case 'pending':
      return (
        <Badge
          variant="secondary"
          className="text-yellow-700 bg-yellow-100 dark:text-yellow-400 dark:bg-yellow-900/30"
        >
          Pending
        </Badge>
      )
