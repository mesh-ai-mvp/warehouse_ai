...
const getTrendColor = (direction: string) => {
  switch (direction) {
    case 'up': return 'text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/50'
    case 'down': return 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/50'
